...
ig_backbone_bundle:	
	jspm build ig_backbone dist/ig_backbone.bundle.js --format umd --skip-encode-names --global-name IGBackbone --config jspm.build.amd.json --global-deps '{"jquery":"$$", "underscore":"_"}'

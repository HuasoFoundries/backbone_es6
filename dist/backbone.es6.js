...
_.extend(Router.prototype, Events, {
  ...
  route: function (route, name, callback) {
    ...
    var router = this;
    Backbone$1.history.route(route, function (fragment) {
...
export { Backbone$1 as Backbone, VERSION, $, noConflict, emulateHTTP, emulateJSON, sync, ajax, Events, on, listenTo, off, stopListening, once, listenToOnce, trigger, bind, unbind, Model, Collection, View, Router, History, history };
export default Backbone$1;

...
var createAssigner = function (keysFunc, undefinedOnly) {
  return function (obj) {
    ...
    for (var index = 1; index < length; index++) {
      ...
      for (var i = 0; i < l; i++) {
        var key = keys[i];
        if (!undefinedOnly || obj[key] === void 0) obj[key] = source[
          key];
      }
    }
    return obj;
...
function createIndexFinder(dir, predicateFind, sortedIndex) {
  return function (array, item, idx) {
    ...
    for (idx = dir > 0 ? i : length - 1; idx >= 0 && idx < length; idx +=
      dir) {
...
var executeBound = function (sourceFunc, boundFunc, context, callingContext,
  args) {
  if (!(callingContext instanceof boundFunc)) return sourceFunc.apply(
    context, args);
...
_.bind = function (func, context) {
  ...
  var args = slice.call(arguments, 2);
  var bound = function () {
    return executeBound(func, bound, context, this, args.concat(slice.call(
      arguments)));
  };
  return bound;
};
